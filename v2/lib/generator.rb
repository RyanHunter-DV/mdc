class Generator ##{
	...
	def __copyrightAndDeclaration__ ##{{{
		cnts = [];
		cnts << 'Author: RyanHunter';
		cnts << "Created: #{Time.now}";
		cnts << 'Description:';
		cnts << 'This file is automatically generated by MDC-v2, any issues found';
		cnts << 'here should be modified in its source markdown document the same';
		cnts << 'dir structure in Git/Obsidian/...';
	end ##}}}
